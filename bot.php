...
if ($type == 'join' || $command == '/menu') {
    $text = "Hallo semuanya... terimakasih telah mengundang Kura KeGrup ini, Silakan ketik 'Key' tanpa tanda petik untuk mengetahui isi keyword dari Kura silakan mencoba... ^_^";
    $balas = array(
