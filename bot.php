...
if ($type == 'join' || $command == '/menu') {
    $text = "Hallo semuanya terimaksih sudah mengundang Kura kura keGrup ini ya, jika ingin mengetahui keyword Kura silakan ketik 'Key' tanpa tanda petik silakan mencoba";
    $balas = array(
