...
if ($type == 'join' || $command == '/menu') {
    $text = "Hallo semuanya... terimakasih telah mengundang Kura KeGrup ini, silakan ketik 'key' tanpa tanda petik untuk mengetahui isi keyword dari Kura silakan dicoba...^_^";
    $balas = array(
